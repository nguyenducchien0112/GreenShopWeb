        ...
        <c:otherwise>
          <main class="col-lg-9 mb-lg-0 mb-3">
            <div class="card">
              ...
              <div class="card-body border-top">
                <button type="button" class="btn btn-primary float-end" id="checkoutBtn" disabled>Tiến hành đặt hàng</button>
          ...
          <aside class="col-lg-3">
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="form-check mb-2">
                    ...
                    <label class="form-check-label" for="payment-cash">Thanh toán bằng tiền mặt</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" type="radio" name="payment-method" id="payment-qr" value="qr">
                    <label class="form-check-label" for="payment-qr">Thanh toán qua QR(Nội dung ghi rõ họ tên, số điện thoại)</label>
                  </div>
                </form>
              </div> <!-- card-body.// -->
            </div> <!-- card.// -->
            ...
            <div id="qr-code-container" style="display:none;">
              <p><strong>Thanh toán qua QR:</strong></p>
              <img id="qr-code" src="${pageContext.request.contextPath}/img/qrcode.png" alt="QR Code" style="width: 150px; height: 150px;"/>
            </div>
...
<script>
  // Lắng nghe sự thay đổi trong phương thức thanh toán
  document.querySelectorAll('input[name="payment-method"]').forEach((elem) => {
    elem.addEventListener("change", function(event) {
      if (event.target.value === "qr") {
        document.getElementById("qr-code-container").style.display = "block"; // Hiển thị mã QR
      } else {
        document.getElementById("qr-code-container").style.display = "none"; // Ẩn mã QR
      }
    });
  });
</script>
