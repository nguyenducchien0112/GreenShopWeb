...
<head>
  ...
  <style>
    ...
    .img-wrap {
      /* Có thể cần điều chỉnh để ảnh không làm vỡ layout */
    ...
    .card {
      display: flex;
      flex-direction: column;
      height: 100%; /* Để các card có chiều cao bằng nhau */
    }

    .card .info-wrap {
      display: flex;
      flex-direction: column;
      height: 100%; /* Để info-wrap lấp đầy chiều cao còn lại của card */
    ...
    .card .title {
      ...
      margin-bottom: 0.5rem; /* Đẩy tiêu đề lên trên, tạo khoảng trống ở dưới */
    }

    .card .info-wrap > div {
      /* Phần tử chứa giá sẽ tự động ở dưới do title có margin-bottom: auto */
    }
  </style>
</head>
    ...
    <div class="row">
      ...
      <main class="col-md-7">
        ...
        <dl class="row mb-4">
          ...
          <dt class="col-xl-4 col-sm-5 col-6">Nhà sản xuất</dt>
          <dd class="col-xl-8 col-sm-7 col-6">${requestScope.product.publisher}</dd>

          <dt class="col-xl-4 col-sm-5 col-6">Năm sản xuất</dt>
