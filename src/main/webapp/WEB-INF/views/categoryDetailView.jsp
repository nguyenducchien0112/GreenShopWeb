...
<head>
  ...
  <title>Thông tin danh mục #${requestScope.category.id}</title>
</head>
    ...
    <div class="card mb-5">
      <div class="card-body">
        <dl class="row">
          ...
          <dt class="col-md-3">Tên danh mục</dt>
          <dd class="col-md-9">
          ...
          <dt class="col-md-3">Mô tả danh mục</dt>
          <dd class="col-md-9">${requestScope.category.description}</dd>

          <dt class="col-md-3">Hình danh mục</dt>
          <dd class="col-md-9">
            <c:choose>
