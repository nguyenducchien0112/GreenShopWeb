  ...
  <div class="container">
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/productManager/create"
        ...
        <div class="mb-3">
          <label for="product-publisher" class="form-label">Nhà sản xuất <span class="text-danger">*</span></label>
          <input type="text"
        ...
        <div class="mb-3">
          <label for="product-yearPublishing" class="form-label">Năm sản xuất <span class="text-danger">*</span></label>
          <input type="number"
